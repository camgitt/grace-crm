...
export function AIAssistant() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8 relative overflow-hidden rounded-xl h-40">
        <img
        ...
        <div className="relative h-full p-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/20">
              <Sparkles className="text-white/90" size={24} />
            </div>
            <div>
              <h1 className="text-2xl font-semibold text-white">AI Assistant</h1>
              <p className="text-white/60 mt-0.5">Generate personalized messages with AI</p>
            </div>
          </div>
          <div className="hidden md:flex items-center gap-3">
            <div className="w-14 h-14 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/10">
              <MessageSquare className="text-white/80" size={28} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {quickActions.map((action) => (
            <button
              ...
              className={`p-4 rounded-xl border text-left transition-all ${
                selectedAction === action.id
                  ? 'border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800 shadow-sm'
            ...
            >
              ...
              <h3 className="font-medium text-sm text-gray-900 dark:text-dark-100">
                {action.label}
              </h3>
              <p className="text-xs text-gray-500 dark:text-dark-400 mt-1 line-clamp-2">{action.description}</p>
            </button>
          ))}
        </div>
      </div>
