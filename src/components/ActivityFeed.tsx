    ...
    return (
      <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-sm font-medium text-gray-900 dark:text-dark-100">Recent Activity</h2>
        </div>
        <div className="py-8 text-center">
          <Calendar className="mx-auto text-gray-300 dark:text-dark-600 mb-2" size={24} />
