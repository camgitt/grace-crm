        ...
        <div className="pt-3 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm bg-stone-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
            >
