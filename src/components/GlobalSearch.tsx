...
export function GlobalSearch({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 pt-20 px-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-xl shadow-2xl">
        <div className="flex items-center gap-3 p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-gray-900 dark:text-white text-lg focus:outline-none"
          />
          <button
            onClick={onClose}
        ...
        {!query && (
          <div className="p-8 text-center text-gray-400">
            ...
            <p className="text-xs mt-2">Tip: Press <kbd className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-700 rounded">Ctrl+K</kbd> to open search</p>
          </div>
        )}
      </div>
    </div>
