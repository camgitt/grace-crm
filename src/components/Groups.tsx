  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">{activeGroups.length} active groups</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        {activeGroups.map((group) => {
          ...
          return (
            <div key={group.id} className="bg-white rounded-2xl border border-gray-200 p-6">
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <p className="text-xs text-gray-400 mb-2">{members.length} members</p>
                <div className="flex -space-x-2">
                  {members.slice(0, 5).map((member) => (
                    <div
                      key={member.id}
                      className="w-8 h-8 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-full flex items-center justify-center text-white text-xs font-medium border-2 border-white"
                  ...
                  {members.length > 5 && (
                    <div className="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center text-gray-500 text-xs font-medium border-2 border-white">
                      +{members.length - 5}
                    </div>
                  )}
                </div>
