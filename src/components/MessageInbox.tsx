          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                aria-label={selectedMessage.status === 'flagged' ? 'Remove flag' : 'Flag message'}
                aria-pressed={selectedMessage.status === 'flagged'}
              >
                <Flag size={16} />
              </button>
              <button
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={onRefresh}
          disabled={isLoading}
          aria-label={isLoading ? 'Refreshing messages' : 'Refresh inbox'}
