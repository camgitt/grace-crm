            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-dark-600 bg-white dark:bg-dark-800 text-gray-900 dark:text-dark-100 placeholder-gray-400 dark:placeholder-dark-500 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none text-sm"
                />
              </div>
          ...
          {currentStep === 'services' && (
            <div className="space-y-4">
                ...
                {serviceTimes.map((st, idx) => (
                  <div key={idx} className="flex items-center gap-2 p-3 rounded-lg bg-gray-50 dark:bg-dark-800 border border-gray-200 dark:border-dark-700">
                    <select
                      ...
                      className="px-2 py-2 rounded-lg border border-gray-300 dark:border-dark-600 bg-white dark:bg-dark-750 text-gray-900 dark:text-dark-100 text-sm focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none"
                    >
                    ...
                    <select
                      ...
                      className="w-32 px-2 py-2 rounded-lg border border-gray-300 dark:border-dark-600 bg-white dark:bg-dark-750 text-gray-900 dark:text-dark-100 text-sm focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none"
                    >
                    ...
                    <input
                      ...
                      className="flex-1 px-2 py-2 rounded-lg border border-gray-300 dark:border-dark-600 bg-white dark:bg-dark-750 text-gray-900 dark:text-dark-100 text-sm focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none"
                    />
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-500/5 rounded-lg transition-colors"
              >
                <Plus size={14} />
                Add another service
              </button>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <button
                  ...
                  className="flex flex-col items-center gap-3 p-5 rounded-xl border-2 border-dashed border-gray-300 dark:border-dark-600 hover:border-slate-400 dark:hover:border-slate-500 hover:bg-slate-50 dark:hover:bg-slate-500/5 transition-all group"
                >
                  <div className="w-12 h-12 bg-slate-100 dark:bg-slate-500/10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    <Plus className="text-slate-600 dark:text-slate-400" size={24} />
                  </div>
