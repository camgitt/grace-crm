      ...
      <div className="grid grid-cols-1 gap-3">
        {filtered.map((person) => (
          <button
            ...
            className="bg-white dark:bg-dark-850 rounded-xl border border-gray-200 dark:border-dark-700 p-4 flex items-center justify-between hover:border-indigo-200 dark:hover:border-indigo-500/30 hover:shadow-sm transition-all group text-left"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 dark:text-dark-400">{person.email}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
