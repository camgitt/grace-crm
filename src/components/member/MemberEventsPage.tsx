...
const categoryColors: Record<CalendarEvent['category'], { bg: string; text: string; label: string }> = {
  ...
  event: { bg: 'bg-slate-100 dark:bg-slate-500/10', text: 'text-slate-600 dark:text-slate-400', label: 'Event' },
  ...
  obituary: { bg: 'bg-stone-100 dark:bg-stone-500/10', text: 'text-stone-600 dark:text-stone-400', label: 'Obituary' },
  ceremony: { bg: 'bg-slate-100 dark:bg-slate-500/10', text: 'text-slate-600 dark:text-slate-400', label: 'Ceremony' },
