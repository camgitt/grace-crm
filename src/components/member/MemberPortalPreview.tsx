          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-dark-800 rounded-2xl border border-gray-200 dark:border-dark-700 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-dark-400">Test on your mobile device</p>
                </div>
              </div>
              <div className="flex justify-center p-4 bg-white rounded-xl border border-gray-100 dark:border-dark-600">
                <img src={qrCodeUrl} alt="QR Code to Member Portal" className="w-48 h-48" loading="lazy" />
              </div>
            ...
            <div className="bg-white dark:bg-dark-800 rounded-2xl border border-gray-200 dark:border-dark-700 p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-dark-100">Portal URL</h3>
                  <p className="text-sm text-gray-500 dark:text-dark-400">Share with your members</p>
                </div>
              </div>
            ...
            <div className="bg-amber-50 dark:bg-amber-500/10 rounded-2xl border border-amber-200 dark:border-amber-500/20 p-4">
              <h4 className="font-medium text-amber-800 dark:text-amber-400 mb-2">Admin Preview Mode</h4>
              <p className="text-sm text-amber-700 dark:text-amber-300/80">
                You're viewing the portal as an admin. Members will need to sign in with their phone or email to access their personalized content.
              </p>
            </div>
          </div>
        </div>
