...
const accentColors = {
  emerald: {
    ...
    iconBg: 'bg-stone-100 dark:bg-emerald-900/30',
    sparkline: '#10b981',
  },
  amber: {
    ...
    iconBg: 'bg-stone-100 dark:bg-amber-900/30',
    sparkline: '#f59e0b',
  },
  rose: {
    ...
    iconBg: 'bg-stone-100 dark:bg-rose-900/30',
    sparkline: '#f43f5e',
  },
  blue: {
    ...
    iconBg: 'bg-stone-100 dark:bg-blue-900/30',
    sparkline: '#3b82f6',
  },
  violet: {
    ...
    iconBg: 'bg-stone-100 dark:bg-slate-900/30',
    sparkline: '#8b5cf6',
  },
  slate: {
