-- ============================================================
-- GRACE CRM - Complete Reset & Seed Script
-- Generated by combining all migrations and seed data
-- ============================================================
-- HOW TO USE:
-- 1. Go to Supabase Dashboard > SQL Editor
-- 2. Paste this entire file and run it
-- 3. It will drop everything, recreate schema, and seed test data
-- ============================================================

-- ############################################################
-- SECTION 1: RESET
-- Drop all tables in reverse dependency order with CASCADE
-- Drop all functions created by migrations
-- ############################################################

-- Drop tables from migration 004 (agent logging system)
DROP TABLE IF EXISTS agent_executions CASCADE;
DROP TABLE IF EXISTS agent_stats CASCADE;
DROP TABLE IF EXISTS agent_logs CASCADE;

-- Drop tables from migration 003 (AI messaging system)
...
-- Drop tables from migration 002b (leader onboarding & sessions)
...
-- Drop tables from migration 002a (collection & donation system)
...
-- Drop tables from migration 001 (initial schema)
