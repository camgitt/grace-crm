...
INSERT INTO tasks (id, church_id, person_id, title, description, due_date, completed, priority, category, assigned_to, created_at) VALUES
  ('22222222-2222-2222-2222-222222222201', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', 'Follow up with Sarah Mitchell', 'First-time visitor on 12/29. Send welcome email and invite to coffee.', '2025-01-25', false, 'high', 'follow-up', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2024-12-29'),
  ('22222222-2222-2222-2222-222222222202', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000007', 'Connect Lisa Thompson with kids ministry', 'New visitor with 2 kids. Introduce to childrens pastor.', '2025-01-26', false, 'high', 'follow-up', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '2025-01-01'),
  ('22222222-2222-2222-2222-222222222203', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000005', 'Check in on Emily Johnson', 'Inactive 6 weeks. Last mentioned job stress. Care call needed.', '2025-01-24', false, 'medium', 'care', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2024-12-20'),
  ('22222222-2222-2222-2222-222222222204', '11111111-1111-1111-1111-111111111111', NULL, 'Prepare Q1 giving report', 'Compile giving data for elder meeting.', '2025-01-31', false, 'low', 'admin', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '2025-01-01'),
  ('22222222-2222-2222-2222-222222222205', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000003', 'Thank Maria for bringing guest', 'She brought Sarah to service. Send appreciation note.', '2025-01-03', true, 'medium', 'outreach', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2024-12-30'),
  ('22222222-2222-2222-2222-222222222206', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000013', 'Follow up with Cam 1993', 'First-time visitor looking for church home. Send welcome email.', '2025-01-25', false, 'high', 'follow-up', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2025-01-21'),
  ('22222222-2222-2222-2222-222222222207', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000014', 'Follow up with Marcus Taylor', 'James Petersons coworker. First church visit in 5 years.', '2025-01-26', false, 'high', 'follow-up', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2025-01-23'),
  ('22222222-2222-2222-2222-222222222208', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000015', 'Connect Ashley with young adults', 'Graduate student interested in young adults group.', '2025-01-27', false, 'high', 'follow-up', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '2025-01-24'),
  ('22222222-2222-2222-2222-222222222209', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000023', 'Check on Michelle Youngs family', 'Family health issues. Send care package and follow up.', '2025-01-26', false, 'high', 'care', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2025-01-10'),
  ('22222222-2222-2222-2222-222222222210', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000016', 'Invite Brian Cooper to membership class', 'Regular attender for 4 months. Ready for next step.', '2025-01-31', false, 'medium', 'follow-up', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2025-01-17'),
  ('22222222-2222-2222-2222-222222222211', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000020', 'Thank Christopher Hall for first gift', 'Made first donation last week. Personal thank you.', '2025-01-24', false, 'medium', 'outreach', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2025-01-17'),
  ('22222222-2222-2222-2222-222222222212', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000024', 'Acknowledge Richard Andersons missions gift', '$5,000 missions gift. Schedule coffee with pastor.', '2025-01-25', false, 'high', 'outreach', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2025-01-21'),
  ('22222222-2222-2222-2222-222222222213', '11111111-1111-1111-1111-111111111111', NULL, 'Plan February events calendar', 'Coordinate with ministry leaders for February events.', '2025-01-28', false, 'low', 'admin', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '2025-01-20'),
  ('22222222-2222-2222-2222-222222222214', '11111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000022', 'Birthday outreach to Andrew Clark', 'Inactive member birthday tomorrow. Good re-engagement opportunity.', '2025-01-25', false, 'medium', 'care', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '2025-01-24'),
  ('22222222-2222-2222-2222-222222222215', '11111111-1111-1111-1111-111111111111', NULL, 'Review volunteer schedule', 'Ensure all Sunday positions are filled for February.', '2025-01-30', false, 'medium', 'admin', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '2025-01-22')
ON CONFLICT (id) DO NOTHING;
